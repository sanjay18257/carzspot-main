...
<div class="h10">
        <h10>Periodic  services</h10>
    </div>
    <br/>
    <div >
        <h11>General Service</h11>
    </div>
    <br/>
    <br/>
    <div>
        <p10>
        Your last Service was on 25/11/2022 @ 10000 Km  
        </p10>
    </div>
    <br/><br/>
    <div >
        <Link to ='/gcu'><button class="button custom-btn btn-7" onclick="openForm()"><span><br/>+ Update last service Date <br/></span></button></Link>
        <Link to ='/gcs'><button class="button custom-btn btn-7" onclick="openForm()"><span><br/>+ Shedule your next service <br/></span></button></Link>
    </div>
    <br/><br/>
    <div>
        <h11>Oil Change</h11>
    ...
    <div>
        <p10>
        Your last Oil Change was on 25/11/2022 @ 10000 Km  
        </p10>
    </div>
    <br/><br/>
    <div >
        <Link to='/ocu'><button class="button custom-btn btn-7" onclick="openForm()"><span><br/>+ Update last Oil Change Date <br/></span></button></Link>
        <Link to ='/ocs'><button class="button custom-btn btn-7" onclick="openForm()"><span><br/>+ Shedule your next Oil Change <br/></span></button></Link>
    </div>
    <br/><br/>
    <div>
        <h11>Tyre Change</h11>
    ...
    <div>
        <p10>
        Your last tyre change was on 25/11/2022 @ 10000 Km  
        </p10>
    </div>
    <br/><br/>
    <div >
        <Link to='/tcu'><button class="button custom-btn btn-7" onclick="openForm()"><span><br/>+ Update last tyre change Date <br/></span></button></Link>
        <Link to='/tcs'><button class="button custom-btn btn-7" onclick="openForm()"><span><br/>+ Shedule your next tyre change <br/></span></button></Link>
    </div>
    <br/><br/>
    <div>
        <h11>Insurance</h11>
    ...
    <div>
        <p10>
        Your Insurance Expires on 25/11/2022 
        </p10>
    </div>
    <br/><br/>
    <div>
        <button class="button custom-btn btn-7" onclick="openForm()"><span><br/>+ Renew Insurance <br/></span></button>
        <Link to='/insur'><button class="button custom-btn btn-7" onclick="openForm()"><span><br/>+ Shedule your Insurance Renewal<br/></span></button></Link>
    </div>
    <br/><br></br>
    <div className="f1">
