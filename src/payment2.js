    ...
    <><><><div className='n1'>
            ...
            <div class="heading">
                ...
                <div class="grid-container">
                    ...
                    <div class="label-cell  Text-1"><p class="order-details">Comprehensive Service</p></div>
                    ...
                    <div class="label-cell Text-4 bottom-border"><p class="order-details">August 01, 2023</p></div>
                </div>
                <label class="base-label margin-40">Order Details</label>
                <ul class="leaders">
                    <li class="margin-20"><span>12 month&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Core Cleaning</span>
                        <span>$1500.00</span></li>
                    <li class="margin-20"><span>12 month&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Service</span>
                        <span>$500.00</span></li>
                    <li class="margin-40"><strong><span>Total</span>
                        <span>$2000.00</span></strong></li>
                </ul>
