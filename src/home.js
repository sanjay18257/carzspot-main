...
function Home(){
    ...
    <div className="lb">
      ...
      <Link to='/both'><input className="Loginf" type="submit" value='Log In' /></Link>
      <Link to='/sign'><input className="signupf" type="submit" value='Sign Up' /></Link>
        </div>
    ...
    <div className="border1">
        ...
        <div className='rs3'><div className="border5">
                <img src={tyre} alt="Tyre"/>
                </div></div>
        <div className='rs4'><div className="border6">
                <img src={im} alt="Im"/>
                </div></div>
        <div className='rs5'><div className="border7">
                <img src={i} alt="In"/>
                </div></div>
        <div className='rs6'><div className="border8">
                <img src={sr} alt="Sr"/>
                </div></div>
        <div className="rs7">Brand Support</div>
...
•  Car Periodic Services<br/>• Car Denting and Painting Services<br/>• Car Battery Replacement Services<br/>• Car Spa and Cleaning Services<br/>• Car AC Service and Repairs<br/>• Car Tyre and Wheel care Services</div>
                ...
                <div className="rs13">• Car Accessories<br/>• Car Custom Repair Services<br/>• Car Detailing Services<br/>• Car Windshields and Lights Services<br/>• Car Clutch and Fitments Services</div>
       <div className="f1">
