    ...
    <><><><div className='n1'>
            ...
            <div class="heading">
                ...
                <div class="grid-container">
                    ...
                    <div class="label-cell  Text-1"><p class="order-details">Standard Service</p></div>
                    ...
                    <div class="label-cell Text-4 bottom-border"><p class="order-details">January 01, 2023</p></div>
                </div>
                <label class="base-label margin-40">Order Details</label>
                <ul class="leaders">
                    <li class="margin-20"><span>6 month&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Core Cleaning</span>
                        <span>$150.00</span></li>
                    <li class="margin-20"><span>6 month&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Service</span>
                        <span>$50.00</span></li>
                    <li class="margin-40"><strong><span>Total</span>
                        <span>$200.00</span></strong></li>
                </ul>
