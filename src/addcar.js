  ...
  return(
    <>
      ...
      <div>
        ...
        <div className='acc2'>Car Brand:  <div class='inputHa'><div class="input-containerHa">
            <input class="input-fieldHa" type="text" placeholder="Brand" required></input>
          </div></div></div>
        <div className='acc3'>Car Model: <div class='inputHac'><div class="input-containerHac">
            <input class="input-fieldHac" type="text" placeholder="Model" required></input>
          </div></div></div>
        
     <Link to='/acc'> <div className='rs69'><div className="border89">
      Submit
      </div></div></Link>
