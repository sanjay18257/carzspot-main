...
function Acc(){
  return(
    <><>
      ...
      <div>
        <div className='acc1'>Account Details</div>
        <div className='acc2'>Your Name     : Shreethic</div>
        <div className='acc3'>Phone Number  : 9787334759</div>
        <div className='acc4'>Email  :  rrsssy23@gmail.com</div>
        <Link to ='/mc'><div className='rs67'><div className="border87">
          My Cars
        </div></div></Link>
      </div>
      <Link to='/ac'><div className='rs68'><div className="border88">
        Add Cars
      </div></div></Link>
